...
const ICONS = {
  ...
  assistant: 'M9.813 15.904 9 18.75l-.813-2.846a4.5 4.5 0 0 0-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 0 0 3.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 0 0 3.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 0 0-3.09 3.09Zm8.446-7.189L18 9.75l-.259-1.035a3.375 3.375 0 0 0-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 0 0 2.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 0 0 2.456 2.456L21.75 6l-1.035.259a3.375 3.375 0 0 0-2.456 2.456Z',
};
...
const ROLE_LINKS = {
  ...
  student: [
    ...
    { name: 'Messages', to: '/messages', icon: ICONS.messages },
    { name: 'Leaderboard', to: '/leaderboard', icon: ICONS.leaderboard },
    { name: 'AI Assistant', to: '/ai-assistant', icon: ICONS.assistant },
    { name: 'Profile', to: '/profile', icon: ICONS.profile },
    { name: 'Settings', to: '/settings', icon: ICONS.settings },
  ],
};
